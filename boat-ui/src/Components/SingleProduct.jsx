    ...
    return <div style={{width:"100%",border:"1px solid red",display:"flex",
        ...
        >
            ...
            <p style={{marginLeft:"20px",marginTop:"-10px",fontWeight:"bolder"}}>₹{salePrice}
                ...
                <span style={{marginLeft:"10px",color:"green",fontWeight:"lighter"}}>{discount}% OFF</span>
            </p> 

            <button style={{width:"90%" , margin:"auto",padding:"10px",borderRadius:"10px"
               ,fontSize:"16px",backgroundColor:"black",color:"white",marginBottom:"10px"}}
            >
                 Add To Cart
            </button>
    </div>
