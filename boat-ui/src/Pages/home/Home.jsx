...
const Homepage = () => {
    ...
    return <div className={styles.mainBox} >
        ...
        <div className={styles.mainBanner}>
            ...
            <img 
               src="https://www.boat-lifestyle.com/cdn/shop/files/img_4_desktop_e51eb905-3de3-4323-8dc3-b2362bd879e2_2000x.png?v=1686650793" 
               alt="banner" 
               width="50%" 
               style={{ marginRight: "45%" }} 
            />
        ...
        <div  className={styles.mainBanner}>
            ...
            <img 
               src="https://www.boat-lifestyle.com/cdn/shop/files/img_5_desktop_993080a5-771b-4fbd-961a-a4dae9e55838_2000x.png?v=1686650885" 
               alt="banner" 
               width="40%" 
               style={{ marginLeft: "45%" }} 
            />
        ...
        <div className={styles.mainBanner}>
            ...
            <img 
               src="https://www.boat-lifestyle.com/cdn/shop/files/img_6_desktop_89f81470-5a48-4b29-a73f-e52e4e94a215_2000x.png?v=1686650906" 
               alt="banner" 
               width="50%" 
               style={{ marginRight: "45%" }} 
            />
        ...
        <div className={styles.mainBanner}>
            ...
            <img 
               src="https://www.boat-lifestyle.com/cdn/shop/files/img_7_desktop_acb84546-2e5d-4f69-bd03-3fd2ca9740db_2000x.png?v=1686650930" 
               alt="banner" 
               width="75%" 
               style={{ marginLeft: "20%", marginTop:"200px" }} 
            />
        </div>
