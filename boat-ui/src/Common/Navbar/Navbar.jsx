...
const Navbar = () => {
    ...
    <div className="w-full h-15 top-0 flex content-center sticky z-10 bg-white border-2 max-w-[1440px] relative m-auto border-#e5e5e5">
        ...
        <div  className="w-1/12 flex gap-2.5 m-2.5">
            <img src="https://static.vecteezy.com/system/resources/thumbnails/002/318/271/small/user-profile-icon-free-vector.jpg" alt="profile-logo" className="w-10 h-10 rounded cursor-pointer" onClick={()=> setShowLogin(true)} />
        ...
        <div className={`${showLogin? 'w-[220px]  h-[80px]  shadow-2xl rounded  border border-black-1 fixed top-[90px] right-[10px] z-10 bg-white':"hidden"} `} >
